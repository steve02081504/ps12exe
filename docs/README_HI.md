...
Windows 11 पर PowerShell 7.6.6 (.NET 10) और Windows PowerShell 5.1 के साथ मापा गया, प्रत्येक को वार्म-अप के बाद 20 बार चलाया गया। प्रोसेस निर्माण की न्यूनतम सीमा (`cmd /c exit`) लगभग 15 ms है। `pwsh -File ../tools/Benchmark/Compare-Compilers.ps1 -IncludeCore` से दोबारा चलाएँ।

| बिल्ड                                          | आउटपुट आकार  | वार्म स्टार्टअप |
| ---------------------------------------------- | ------------ | --------------- |
| Windows PowerShell 5.1 से स्क्रिप्ट सीधे चलाना | —            | ~245 ms         |
| ps12exe · कॉन्स्टेंट · Framework4.0            | 1024 बाइट्स  | ~33 ms          |
| ps12exe · नॉन-कॉन्स्टेंट · Framework4.0        | 14848 बाइट्स | ~210 ms         |
| PS2EXE 1.0.18 · नॉन-कॉन्स्टेंट                 | 25088 बाइट्स | ~223 ms         |
| ---------------------------------------------- | ------------ | --------------- |
| pwsh 7 से स्क्रिप्ट सीधे चलाना                 | —            | ~450 ms         |
| ps12exe · कॉन्स्टेंट · Core                    | ~169 KB      | ~70 ms          |
| ps12exe · नॉन-कॉन्स्टेंट · Core                | ~185 KB      | ~395 ms         |
...
| ------------------------ | -------- | -------- |
| ps12exe (वर्तमान master) | ~1.29 MB | ~513 KB  |
