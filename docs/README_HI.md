...
| ---------------------------------------------- | ------------ | --------------- |
| Windows PowerShell 5.1 से स्क्रिप्ट सीधे चलाना | —            | ~235 ms         |
| ps12exe · कॉन्स्टेंट · Framework4.0            | 1024 बाइट्स  | ~41 ms          |
| ps12exe · नॉन-कॉन्स्टेंट · Framework4.0        | 14848 बाइट्स | ~315 ms         |
| PS2EXE 1.0.18 · नॉन-कॉन्स्टेंट                 | 25088 बाइट्स | ~245 ms         |
| ---------------------------------------------- | ------------ | --------------- |
