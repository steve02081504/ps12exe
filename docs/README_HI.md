...
- **exe21sp**: यदि `-OutFile` निर्दिष्ट नहीं है और stdout रीडायरेक्ट **नहीं** है, तो डीकंपाइल स्क्रिप्ट exe के समान नाम की `.ps1` फ़ाइल में उसी फ़ोल्डर में सहेजी जाती है।
- **exe21sp**: यदि `-OutFile` निर्दिष्ट नहीं है और stdout रीडायरेक्ट **है**, तो डीकंपाइल स्क्रिप्ट stdout पर लिखी जाती है।
