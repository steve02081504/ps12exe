...
- `#_pragma noConstEval`: घोषित करता है कि यह स्क्रिप्ट स्थिरांक नहीं है; स्थिरांक मूल्यांकन छोड़ें।
- `#_pragma constEvalTimeout`: घोषित करता है कि यह स्थिरांक मूल्यांकन का समय पहले ही समाप्त हो चुका है; समय समाप्त होने की स्थिति जैसा ही फ़ॉलबैक लागू करें।

दोनों को संकलन समय पर स्क्रिप्ट की सामग्री में कीवर्ड द्वारा मिलान किया जाता है, इसलिए इन्हें किसी भी पंक्ति में रखा जा सकता है; सामान्य होस्ट पर वापस आने के बाद ये पंक्तियाँ केवल सामान्य टिप्पणियाँ होती हैं।
