...
| ビルド                                        | 出力サイズ   | ウォーム起動 |
| --------------------------------------------- | ------------ | ------------ |
| Windows PowerShell 5.1 でスクリプトを直接実行 | —            | ~235 ms      |
| ps12exe · 定数 · Framework4.0                 | 1024 バイト  | ~41 ms       |
| ps12exe · 非定数 · Framework4.0               | 14848 バイト | ~315 ms      |
| PS2EXE 1.0.18 · 非定数                        | 25088 バイト | ~245 ms      |
| --------------------------------------------- | ------------ | ------------ |
