...
Resources        : A hashtable that contains version resources for the compiled executable (Icon, Title, Description, Company, Product, Copyright, Trademark, Version). Icon can be a file path or URL.
