@{
	...
	AgentSkillInstallFailed        = "I'm afraid installing the ps12exe agent skill to {0} did not succeed: {1}"
	AgentSkillUninstalling         = "Removing the ps12exe agent skill from {0} ..."
	AgentSkillUninstallFailed      = "I'm afraid removing the ps12exe agent skill from {0} did not succeed: {1}"
	# Web Server
