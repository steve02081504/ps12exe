@{
	...
	AgentSkillInstalling           = "Installing the ps12exe agent skill to {0} ..."
	AgentSkillInstallFailed        = "Failed to install the ps12exe agent skill to {0}: {1}"
	AgentSkillUninstalling         = "Removing the ps12exe agent skill from {0} ..."
	AgentSkillUninstallFailed      = "Failed to remove the ps12exe agent skill from {0}: {1}"
	# Web Server
...
"@
	...
	IntegrationHelpData            = @{
		title      = "Usage:"
		Usage      = "Set-ps12exeIntegration [[-action] 'enable'|'disable'|'reset'] [-Locale '<language code>'] [-Skip <'ContextMenu'|'AgentSkill'|'VSCodeExtension'>] [-help]"
		PrarmsData = [ordered]@{
			action = "Action to perform."
			Locale = "Language code to use."
			Skip   = "Integration items to skip; any of 'ContextMenu', 'AgentSkill' and 'VSCodeExtension'."
			help   = "Show this help message."
		}
	}
	WebServerHelpData              = @{
	...
	CompilingI18nData              = @{
		...
		DllExportCompiling                        = "Generating native DLL exports for #_DllExport..."
		DllExportToolchainFailed                  = "The AsmResolver assemblies required for native exports are unavailable: {0}"
		DllExportMethodNotFound                   = "Export method {0} was not found in the generated assembly."
		DllExportForcePlatform                    = "Native exports do not support AnyCPU; target platform set to {0}."
		DllExportCoreUnsupported                  = "#_DllExport does not support Build.Target='Core'; use Framework4.0."
		DllExportFramework2Unsupported            = "#_DllExport does not support Framework2.0; use Framework4.0."
		DllExportPlatformUnsupported              = "#_DllExport does not support platform {0} (x86/x64 only)."
	}
	WebServerI18nData              = @{
