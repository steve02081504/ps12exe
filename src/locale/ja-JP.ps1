...
"@
	...
	exe21spHelpData			= @{
		title	   = "用法："
		Usage	   = "exe21sp [-ExePath] '<exeファイルパス>' [-OutFile '<出力ps1パス>'] [-help]"
		PrarmsData = [ordered]@{
			ExePath = "反コンパイルする ps12exe 生成 exe のパス。"
			OutFile = "省略可。復元スクリプトを書き出す ps1 のパス。省略時は標準出力へ。"
			help	= "このヘルプを表示。"
		}
	}
	ConsoleHelpData			= @{
	...
	exe21spI18nData			= @{
		...
		ExePathRequired				 = "exe21sp: -ExePath が必要です。用法は -help を参照してください。"
